...
exports.default = _createFullPath;
/**
 ...
 */
function _createFullPath(resolvedPath, isAuthRequest, basePathOverride) {
  return ((isAuthRequest ? '' : (basePathOverride || this.basePath) + '/') + resolvedPath).replace(/\/+/g, '/');
}